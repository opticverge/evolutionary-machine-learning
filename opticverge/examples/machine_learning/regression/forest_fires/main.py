...
from opticverge.examples.machine_learning.regression.forest_fires.problem import ForestFiresPredictionProblem
from opticverge.external.scikit.chromosome.regression.ensemble import XGBRegressorChromosome, \
    GradientBoostingRegressorChromosome, AdaBoostRegressorChromosome
...
def run():
    try:
        problem = ForestFiresPredictionProblem(
