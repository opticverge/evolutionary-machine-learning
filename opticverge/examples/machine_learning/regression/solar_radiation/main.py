...
from opticverge.examples.machine_learning.regression.solar_radiation.problem import SolarRadiationPredictionProblem
from opticverge.external.scikit.chromosome.regression.ensemble import GradientBoostingRegressorChromosome, \
    XGBRegressorChromosome, RandomForestRegressorChromosome, AdaBoostRegressorChromosome
...
def run():
    try:
        problem = SolarRadiationPredictionProblem(
